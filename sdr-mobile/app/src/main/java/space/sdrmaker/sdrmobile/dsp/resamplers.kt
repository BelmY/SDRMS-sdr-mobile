...
class OldComplexDownsampler(private val input: Iterator<Pair<Float, Float>>, private val factor: Int) :
    Iterator<Pair<Float, Float>> {
...
class OldDecimator(input: Iterator<Float>, factor: Int, taps: FloatArray) : Iterator<Float> {

    private val filter = OldFIRFilter(input, taps)
    private val downsampler = OldDownsampler(filter, factor)
...
//class OldComplexDecimator(input: Iterator<Pair<Float, Float>>, factor: Int, taps: FloatArray) :
//    Iterator<Pair<Float, Float>> {
//
